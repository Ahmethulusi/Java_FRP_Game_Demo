public class BlackSmith extends NormalLoc{
    ...
    public boolean onLocatin() {
        ...
        while(flag) {
            ...
            System.out.println("2 level silah geliştirmesi " + weapon_first_development + " gold\n" + "3 level silah geliştirmesi " + weapon_second_development + " gold + 1 Donmuş Yürek + 1 Diş\n" + "4 level silah geliştirmesi " + weapon_third_development + " gold" +" + 1 Donmuş Yürek +" + "1 Yakut"+" + 1 Mistik Diş");
            System.out.println("2 level zırh geliştirmesi " + armor_first_development + " gold\n" + "3 level zırh geliştirmesi " + armor_second_development + "\n" + "4 level zırh geliştirmesi " + armor_third_development+" gold"+" + 1 Donmuş Yürek +" + " 1 Yakut");
            System.out.println("---------------------------------");
